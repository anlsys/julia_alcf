function parse_commandline()
    ...
    @add_arg_table! s begin
        "benchmark"
            help = "benchmark to run: flops, gemm, triad, peer2peer, pci, intranode, topology"
            required = true
        "--size", "-s"
...
function main(backend_type)
    ...
    elseif benchmark == "topology"
        ...
        error("Unknown benchmark: $benchmark. Available: flops, gemm, triad, peer2peer, pci, intranode, topology")
    end
